        ...
        private void FlightDirection(double common_vector_direction)
        {
            ...
            switch (_angle)
            {
                ...
                case < 90 - 3 * _coefficient_rotation_angles:
                    AddForce(vector * 0.70f, vector * 0.30f); Height_acceleration(Lifting_force() * 0.90f); break;

                case < 90 - _coefficient_rotation_angles:
                    AddForce(vector * 0.55f, vector * 0.45f); Height_acceleration(Lifting_force() * 0.70f); break;
                ...
                case < 270 + 4 * _coefficient_rotation_angles:
                    AddForce(vector * 0.75f, -vector * 0.15f); Height_acceleration(Lifting_force() * 0.90f); break;

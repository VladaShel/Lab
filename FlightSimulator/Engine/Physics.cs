...
namespace FlightSimulator
{
    ...
    public class Physics : Transform
    {
        ...
        private const double _friction_force = 1;
        ...
        private const double _speed_limit = 400;
        ...
        public virtual void Tick()
        {
            ...
            if (_acceleration_y == 0)
                _speed_y = ReduceAbs(_speed_y, (Math.Abs(_speed_y) / _windage_coef));

            if (_height_acceleration == 0)
